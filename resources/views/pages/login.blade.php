...
<head>
  ...
  <meta charset="utf-8" />
    <title>Lotus Lisans Giriş</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta content="Lotus Lisans Partnerliği" name="description" />
    <meta content="Alp Eren Doğan" name="author" />
    <!-- favicon -->
...
<body>
    ...
    <form action="{{ route('loginPost') }}" method="POST">
      @csrf
        ...
        <input required type="password" placeholder="Şifre" id="password" name="password">
