                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($files as $file)
                                            ...
                                            <tr>
                                                <td>{{ $id }}</td>
                                                <td>{{ basename($file) }}</td>
                                                <td>{{ Storage::size($file) }}KB</td>
                                                <td>{{ date('d-m-Y H:i:s', $fileLastModified) }}</td>
                                                <td>
                                                    <a href="{{ route('backup.download', ['file' => $file]) }}" download>
                                                        <button class="btn btn-sm btn-soft-warning">İndir</button>
                                                    </a>
                                                </td>
                                            </tr>
                                        @endforeach
