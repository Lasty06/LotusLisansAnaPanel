                            ...
                            <div class="table-responsive">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ DB::table('stock')->where('productId', $product->id)->where('delivery', '1')->count() }}</td>
                                        <td>{{ ($product->active == "1") ? 'Aktif' : 'Pasif' }}</td>
                                        <td>{{ $product->created_at }}</td>
                                        <td>
                                            <a href="{{ route('admin.productupdate',$product->id) }}"><button class="btn btn-sm btn-soft-warning">Düzenle</button></a>
                                            <a href="{{ route('admin.productdelete',$product->id) }}"><button class="btn btn-sm btn-soft-danger">Sil</button></a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
