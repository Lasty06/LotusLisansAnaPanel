                            ...
                            <div class="table-responsive">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('admin.categoryupdate',$category->id) }}"><button class="btn btn-sm btn-soft-warning">Düzenle</button></a>
                                            <a href="{{ route('admin.categorydelete',$category->id) }}"><button class="btn btn-sm btn-soft-danger">Sil</button></a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
