                            ...
                            <div class="table-responsive">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $faq->content }}</td>
                                        <td>
                                            <a href="{{ route('admin.sssupdate',$faq->id) }}"><button class="btn btn-sm btn-soft-warning">Düzenle</button></a>
                                            <a href="{{ route('admin.sssdelete',$faq->id) }}"><button class="btn btn-sm btn-soft-danger">Sil</button></a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
